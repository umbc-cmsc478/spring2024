...
|  | **Supervised Learning** | | 
| Thu <br> Feb 01 | Supervised learning setup, LMS, Gradient Descent <br>[Slides](assets/478-02-GD.pdf) | **[Homework01](https://umbc-cmsc478.github.io/spring2024/assets/assignments/Homework%201/)** | [SML Part 1, Chap 1, 1.1](assets/Lecture-Notes-Stanford-ML.pdf); <br> Optional: [TOS Chapter 2](https://redirect.cs.umbc.edu/courses/undergraduate/478/spring2023/Chapter%202%20-%20Perceptrons.html)<!--Stanford if otherwise not mentioned-->
| **Week 2** | | | 
