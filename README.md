...
|  | **Supervised Learning** | | 
| Thu <br> Feb 01 | Supervised learning setup, LMS, Gradient Descent <br>[Slides](assets/478-02-GD.pdf) | | [SML Part 1, Chap 1, 1.1](assets/Lecture-Notes-Stanford-ML.pdf); <br> Optional: [TOS Chapter 2](https://redirect.cs.umbc.edu/courses/undergraduate/478/spring2023/Chapter%202%20-%20Perceptrons.html)<!--Stanford if otherwise not mentioned-->
| **Week 2** | | | 
...
| **Week 7** |  | | 
| Tue <br> Mar 12 | Naive Bayes <br> [Slides](assets/478-17-NBayes.pdf)  |  | [Mitchell-Notes Chapter 3](http://www.cs.cmu.edu/~tom/mlbook/NBayesLogReg.pdf)
| Thu <br> Mar 14 | Gaussian Naive Bayes <br> [Slides](assets/478-17-NB-GNB.pdf) // Reinforcement Learning <br> [Slides](assets/478-RL-1.pdf) | | 
| **Week 8** | | | 
|  | **Spring Break** | | 
| **Week 9** |  | | 
...
| Thu <br> Apr 18 | Neural Network:Backpropagation <br> [Class-notes-with-algorithm](/assets/NN-back-propagation.pdf) , [Slide2](assets/NN-04.18.pdf) |  [Practice Colab Notebooks](https://drive.google.com/drive/u/0/folders/1sHYHkNUMj_hM3aylwTbKT2J12S-AG73P) | [Chapter 10](http://ciml.info/dl/v0_99/ciml-v0_99-ch10.pdf) of CIML
| **Week 13** | | | |
